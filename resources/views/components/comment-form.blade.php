...
<div class="relative flex items-start gap-x-3">
    ...
    <x-form method="post" action="{{ $action }}" class="relative flex-auto" {{ $attributes }}>
        <div class="overflow-hidden rounded-lg pb-12 shadow-xs ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-blue-600">
        ...
        <div class="absolute inset-x-0 bottom-0 flex justify-between py-2 pl-3 pr-2">
            ...
            <button class="ml-6 rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-700 shadow-xs ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Comment</button>
        </div>
    </x-form>
</div>
